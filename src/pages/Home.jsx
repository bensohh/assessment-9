...
function Home() {
  ...
  const { connectWallet, connected, isLoading } = useWallet();
  ...
  const advantages = [
    ...
    },
    {
      ...
      description:
        "ValorNuvesta handles all property management aspects, from maintenance to tenant relations.",
    },
  ];
  ...
  const investmentSteps = [
    {
      ...
      description:
        "Connect your cryptocurrency wallet to GoldenProp to start investing.",
    },
    {
      icon: FaStore,
      ...
      questions: [
        {
          ...
          answer:
            "GoldenProp is an innovative investment project dedicated to real estate. We allow clients to invest as little as $10 in investment properties, with the aim of building up regular income and/or savings.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "The GoldenProp Marketplace is our platform that allows GoldenProp community members to buy and sell NFTs among themselves.  It is the equivalent of a secondary market where investors can buy and sell NFTs among themselves. We may also cooperate with other marketplaces to allow anyone to choose their preferred marketplace.",
        },
        {
          question:
        ...
        },
        {
          ...
          answer:
            "GoldenProp uses the most advanced technical means to ensure the confidentiality and security of transactions on the platform. ",
        },
      ],
    },
  ];
  ...
  return (
    <div className="space-y-16">
      {/* Hero Section */}
      <section className="relative h-[360px] sm:h-[440px] md:h-[520px] lg:h-[600px] flex items-center justify-center overflow-hidden py-8 sm:py-10">
        ...
        <div className="relative container text-center text-white space-y-8">
          ...
          >
            <motion.h1
              className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 text-white drop-shadow-lg text-center leading-tight"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
            >
      ...
      <section className="container px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-sapphire-800">
          ...
          {investmentSteps.map((step, index) => (
            ...
            >
              <div className="glass-card p-6 text-center group hover:shadow-glass-xl transition-all duration-500">
                ...
                <h3 className="text-xl font-semibold mb-2 text-sapphire-800">
                  {step.title}
                </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {howItWorks.map((item, index) => (
              ...
              >
                ...
                <p className="text-sapphire-200 text-center">
                  {item.description}
                </p>
              </motion.div>
            ))}
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center mb-4">
                  <div>
                    ...
                    <p className="font-semibold text-sapphire-800">
      ...
      {/* CTA Section */}
      <section className="container px-4 sm:px-6 lg:px-8">
        <div className="glass-section bg-gradient-to-br from-primary-600 to-primary-700 p-6 sm:p-8 md:p-12 text-white text-center relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-primary-500/20 to-transparent"></div>
          <div className="relative">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4">
              Ready to Start Investing?
            </h2>
            <p className="text-base sm:text-lg mb-8 max-w-2xl mx-auto text-white/95 drop-shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                ...
                className="btn bg-gradient-to-r from-primary-700 to-primary-800 hover:from-primary-800 hover:to-primary-900 disabled:opacity-50 disabled:cursor-not-allowed"
              >
      ...
      {/* Blog */}
      <div className="container bg-white py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
